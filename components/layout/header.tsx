        ...
        <div className="flex h-14 md:h-16 justify-between items-center">
          ...
          <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-4 min-w-0 flex-1">
            <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3 min-w-0">
              ...
              <h1 className="text-sm sm:text-lg md:text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent truncate">
                {t(pageTitle)}
              </h1>
            </div>
          ...
          <div className="flex items-center space-x-0.5 sm:space-x-1 md:space-x-2 lg:space-x-4">
            ...
            <div className="relative hidden md:block">
              ...
              <input
                ...
                className="w-48 lg:w-64 pl-10 pr-4 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="hidden sm:flex items-center space-x-1 md:space-x-2 lg:space-x-3 cursor-pointer bg-gray-50 dark:bg-gray-800 rounded-lg md:rounded-xl p-1 md:p-1.5 lg:p-2 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                  <Avatar className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8 ring-2 ring-blue-500/20">
                    <AvatarImage src="/placeholder-user.jpg" alt="User" />
                    <AvatarFallback className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-xs md:text-sm">
                      JD
                    </AvatarFallback>
                  </Avatar>
