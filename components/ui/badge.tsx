  ...
  "inline-flex items-center rounded-2xl border px-3 py-1.5 text-xs font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-sm",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-gradient-to-r from-green-500 to-green-600 text-white shadow-lg",
        warning: "border-transparent bg-gradient-to-r from-orange-500 to-orange-600 text-white shadow-lg",
        info: "border-transparent bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg",
